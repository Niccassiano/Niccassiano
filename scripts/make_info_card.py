...
svg_content = '''<svg width="530" height="380" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(20, 48)">
    ...
    <text y="295" class="text" style="animation-delay: 0.7s">  <tspan class="key">"status"</tspan>: <tspan class="string">"200 OK | Pronta para novos desafios e contribuicoes."</tspan></text>
